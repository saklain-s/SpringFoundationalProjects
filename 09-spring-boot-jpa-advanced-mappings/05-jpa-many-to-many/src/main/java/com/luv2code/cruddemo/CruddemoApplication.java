...
public class CruddemoApplication {
	...
	private void addMoreCoursesForStudent(AppDAO appDAO) {
		...
		Course tempCourse2 = new Course("Learn Professional Wrestling");
	...
	private void createCourseAndStudents(AppDAO appDAO) {
		...
		// create the students
		Student tempStudent1 = new Student("Saklain","Shaik","saklain@gmail.com");
		Student tempStudent2 = new Student("Surheera","Shaik","surheera@gmail.com");
	...
	private void createCourseAndReview(AppDAO appDAO) {
		...
		tempCourse.addReview( new Review("Cool course ... well-structured"));
		tempCourse.addReview( new Review("What a dumb course ... loved it!"));
